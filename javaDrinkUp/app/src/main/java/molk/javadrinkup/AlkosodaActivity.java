...
public class AlkosodaActivity extends Activity {
        ...
        AdapterView.OnItemClickListener itemClickListener = new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View container, int position, long id) {
                ...
                if(tvDrink.getText().toString().equals("White Russian")){
                    startDrinksInterfaceActivity(linearLayoutChild, 15);
                }
                if(tvDrink.getText().toString().equals("P2")){
                    startDrinksInterfaceActivity(linearLayoutChild, 16);
                }
                if(tvDrink.getText().toString().equals("Vodka Redbull")){
                    startDrinksInterfaceActivity(linearLayoutChild, 17);
                }
                if(tvDrink.getText().toString().equals("Gin & Tonic")){
                    startDrinksInterfaceActivity(linearLayoutChild, 18);
                }
                if(tvDrink.getText().toString().equals("Blue Lagoon")){
                    startDrinksInterfaceActivity(linearLayoutChild, 19);
                }
                if(tvDrink.getText().toString().equals("Screwdriver")){
                    startDrinksInterfaceActivity(linearLayoutChild, 20);
                }
                if(tvDrink.getText().toString().equals("Cuba Libre (Rom & Cola)")){
                    startDrinksInterfaceActivity(linearLayoutChild, 21);
                }
