        ...
        AdapterView.OnItemClickListener itemClickListener = new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View container, int position, long id) {
                ...
                if(tvDrink.getText().toString().equals("Vodka Redbull")){
                    startDrinksInterfaceActivity(linearLayoutChild, 22);
                }
                if(tvDrink.getText().toString().equals("Gin & Tonic")){
                    startDrinksInterfaceActivity(linearLayoutChild, 23);
                }
                if(tvDrink.getText().toString().equals("Blue Lagoon")){
                    startDrinksInterfaceActivity(linearLayoutChild, 24);
                }
                if(tvDrink.getText().toString().equals("Screwdriver")){
                    startDrinksInterfaceActivity(linearLayoutChild, 25);
                }
                if(tvDrink.getText().toString().equals("Cuba Libre (Rom & Cola)")){
                    startDrinksInterfaceActivity(linearLayoutChild, 26);
                }
